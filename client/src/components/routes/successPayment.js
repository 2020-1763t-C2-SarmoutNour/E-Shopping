...
export const SuccessPayment = () => {
  ...
  const shippingAddressForm = useSelector((state) =>
    state.form.shippingAddressForm
      ? state.form.shippingAddressForm.values
      : null,
  );
  ...
  return (
    ...
    >
      ...
      <Grid item container spacing={2}>
        ...
        >
          <Grid item>
            {`${paymentResponse.brand.toUpperCase()} ending in ${
              paymentResponse.last4
            }`}
          </Grid>
          <Grid item>
      ...
      <Grid item container spacing={2}>
        ...
        <Grid
          ...
          style={{ fontWeight: 'bold' }}
        >
          <Grid item>{shippingOption.deliveryType}</Grid>
          <Grid item>
