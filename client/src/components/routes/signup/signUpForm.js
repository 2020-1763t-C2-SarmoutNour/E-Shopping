...
class SignUpForm extends Component {
  ...
  handleSubmit = (event) => {
    ...
    if (!this.props.signUpFormStore.values.termsCheckbox) {
      this.setState({
        errorMsg: 'Please read the terms and conditions. Checkbox is uncheck.',
      });
      return;
    }
  ...
  render() {
    ...
    return (
      <Grid container>
        <form onSubmit={this.handleSubmit} style={{ width: 'inherit' }}>
          <Grid container>
...
const mapStateToProps = (state) => {
  return {
    signUpFormStore: state.form.signUpForm ? state.form.signUpForm : null,
